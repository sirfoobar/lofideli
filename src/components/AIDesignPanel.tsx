...
const AIDesignPanel: React.FC<AIDesignPanelProps> = ({ isOpen, onClose }) => {
  const { generateUIFromPrompt } = useWhiteboard();
  ...
  return (
    <div className="absolute right-0 top-0 bottom-0 w-80 bg-card border-l border-border shadow-lg z-20 overflow-hidden flex flex-col">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        ...
        <TabsContent value="text" className="flex-1 p-4 overflow-y-auto flex flex-col">
