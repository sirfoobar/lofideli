...
const ComponentLibrary: React.FC = () => {
  ...
  return <div className="flex flex-col gap-2">
      <div className="grid grid-cols-2 gap-0">
        {components.map(component => <div key={component.type} className="flex items-center gap-1.5 p-1.5 bg-background hover:bg-accent rounded-md cursor-grab transition-colors" draggable onDragStart={e => handleDragStart(e, component.type)}>
