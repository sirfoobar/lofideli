...
const TopBar: React.FC<TopBarProps> = ({
  ...
  return <div className="h-8 border-b border-border bg-card flex items-center px-4 justify-between">
      <div className="flex items-center">
        ...
        <div className="flex gap-1">
          ...
          <Button variant="ghost" size="icon" onClick={onToggleGrid} title="Toggle Grid">
            <Grid2X2 size={18} />
          </Button>
