...
const FramePropertyPanel: React.FC<FramePropertyPanelProps> = ({
  ...
  const selectedFrame = state.frames.find(
  ...
  const componentsInFrame = state.components.filter(
    (component) => component.frameId === selectedFrameId
  ).length;

  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <span className="text-sm font-small">Frame Properties</span>
        <button
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(value) =>
                handleFrameSizeChange("width", Number(value))
              }
              className="h-8"
            />
          </div>
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(value) =>
                handleFrameSizeChange("height", Number(value))
              }
              className="h-8"
            />
          </div>
        ...
        {/* Set as active frame */}
        <Button 
          onClick={handleSetActiveFrame}
          variant={state.activeFrameId === selectedFrameId ? "secondary" : "default"}
