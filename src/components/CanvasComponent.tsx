    ...
    switch (component.type) {
        ...
        return (
          <div className="w-full h-full flex items-center justify-center bg-white">
            <div className="text-center">
              <div className="text-lg font-medium mb-2">Dialog Title</div>
              <div className="text-sm text-gray-500">Dialog content goes here</div>
            </div>
          </div>
        );
        ...
        return (
          <div className="w-full h-full grid grid-cols-2 gap-2 p-2">
            {Array.from({length: 4}, (_, i) => (
              <div key={i} className="bg-gray-100 rounded p-2 text-sm">Item {i + 1}</div>
            ))}
          </div>
        );
        ...
        return (
          <div className="w-full h-full flex flex-col p-2">
            {Array.from({length: 3}, (_, i) => (
              <div key={i} className="py-1 px-2 hover:bg-gray-100 rounded text-sm">Option {i + 1}</div>
            ))}
          </div>
        );
      ...
      case "menu":
        return (
          <div className="w-full h-full flex flex-col p-2">
            {Array.from({length: 3}, (_, i) => (
              <div key={i} className="py-1 px-2 hover:bg-gray-100 rounded text-sm">Menu Item {i + 1}</div>
            ))}
          </div>
        );
      ...
      case "modal":
        return (
          <div className="w-full h-full flex items-center justify-center bg-white">
            <div className="text-center">
              <div className="text-lg font-medium mb-2">Modal Title</div>
              <div className="text-sm text-gray-500">Modal content goes here</div>
            </div>
          </div>
        );
      ...
      case "searchfield":
        return (
          <div className="w-full h-full flex items-center px-2">
            <div className="w-full text-gray-400">Search...</div>
          </div>
        );
        ...
        return (
          <div className="w-full h-full flex flex-col">
            <div className="flex border-b">
              {Array.from({length: 3}, (_, i) => (
                <div key={i} className="px-4 py-2 text-sm border-b-2 border-blue-500">Tab {i + 1}</div>
              ))}
            </div>
      ...
      case "taggroup":
        return (
          <div className="w-full h-full flex flex-wrap gap-1 p-2">
            {Array.from({length: 3}, (_, i) => (
              <div key={i} className="bg-gray-100 rounded-full px-2 py-1 text-xs">Tag {i + 1}</div>
            ))}
          </div>
        );
      ...
      case "togglebutton":
        return (
          <div className="w-full h-full flex items-center justify-center">
            <div className="px-4 py-2 bg-gray-100 rounded text-sm">Toggle</div>
          </div>
        );
      ...
      case "tooltip":
        return (
          <div className="w-full h-full flex items-center justify-center">
            <div className="text-sm">Hover for tooltip</div>
          </div>
        );
